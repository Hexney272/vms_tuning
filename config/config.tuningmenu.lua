...
Config.TuningMenu = {
    ...
    ["mechanical"] = {
        ...
        options = {
            ...
            {label = 'Motor', icon = 'engine.webp', modType = 11, tax = 'tuning', priceMultiplier = {0.1, 0.15, 0.2}},
            {label = 'Fékek', icon = 'brakes.webp', modType = 12, tax = 'tuning', priceMultiplier = {0.075, 0.125, 0.175}},
            {label = 'Váltó', icon = 'transmission.webp', modType = 13, tax = 'tuning', priceMultiplier = {0.08, 0.16, 0.24}},
